...
public class MainActivity extends AppCompatActivity {
    ...
    private void showFirstTime(){
        startActivity(new Intent(MainActivity.this, loginType.class));
    ...
    private void showProfessionScreen(){
        startActivity(new Intent(MainActivity.this, professionalMainActivityScreen.class));
    }
